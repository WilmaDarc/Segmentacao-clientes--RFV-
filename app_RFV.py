...
def main():
    ...
    st.set_page_config(
        ...
        page_icon='https://github.com/WilmaDarc/Segmentacao-clientes--RFV-', 
        layout="wide",
...
# TÍTULO
    ...
    <div style="text-align:center">
        <a href="https://github.com/WilmaDarc/Segmentacao-clientes--RFV-">
            <img src="https://github.com/user-attachments/assets/df0f71b5-7bae-4751-a85c-92f9cfbf61af" width=100%>
        </a>
    </div> 
